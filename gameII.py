...
# set up notice
notice_display = Label(window, text="")
notice_display.pack()
...
def make_candy():
    if len(candy_list) < 5:
        ...
        candy_to_points[candy] = color_points[candy_color]
...
def update_score_level(points):
    ...
    if score > 50:
        score = 25
        notice_display.config(text="Going past 50! Back to 25!")
        window.after(2000, clear_notice)
    elif score == 50:
        game_over = canvas.create_text(200, 200, text= 'You win!', fill='red', font = ('Helvetica', 30))
